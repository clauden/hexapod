...
var mb = new MaestroIOBoard(maestro, PololuMaestro.TYPES.MICRO_MAESTRO, [
  ...
  //Left front leg
  phoenix.l1c = new five.Servo({pin:3, offset: 0, startAt: l.c, range: [50, 180] });
  ...
  //Right mid leg
  phoenix.r2c = new five.Servo({pin:0, offset: 0, startAt: l.c, range: [50, 130], isInverted: true });
  phoenix.r2f = new five.Servo({pin:1, offset: 0, startAt: l.f, range: [25, 165] });
  phoenix.r2t = new five.Servo({pin:2, offset: 0, startAt: l.t });
  phoenix.r2 = new five.Servo.Array([ phoenix.r2c, phoenix.r2f, phoenix.r2t ]);

  //Left mid leg
  phoenix.l2c = new five.Servo({pin:3, offset: 0, startAt: l.c, range: [50, 130] });
  phoenix.l2f = new five.Servo({pin:4, offset: 0, startAt: l.f, range: [25, 165], isInverted: true });
  phoenix.l2t = new five.Servo({pin:5, offset: 0, startAt: l.t, isInverted: true });
  phoenix.l2 = new five.Servo.Array([ phoenix.l2c, phoenix.l2f, phoenix.l2t ]);

  //Right rear leg
  phoenix.r3c = new five.Servo({pin:0, offset: 0, startAt: l.c, range: [50, 180]});
  phoenix.r3f = new five.Servo({pin:1, offset: 0, startAt: l.f, range: [25, 165] });
  phoenix.r3t = new five.Servo({pin:2, offset: 0, startAt: l.t });
