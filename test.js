...
// var tty = "/dev/tty.usbmodem00087313";
...
// Servo assignments
  ...
  // Right front leg
  phoenix.r1c = new five.Servo({pin:5, offset: 0, startAt: l.c, range: [50, 180], isInverted: true });
  phoenix.r1f = new five.Servo({pin:3, offset: 0, startAt:  l.f, range: [25, 165] });
  phoenix.r1t = new five.Servo({pin:1, offset: 0, startAt: l.t });

  phoenix.r1 = new five.Servo.Array([ phoenix.r1c, phoenix.r1f, phoenix.r1t ]);

  var legsAnimation = new five.Animation(phoenix.r1);
