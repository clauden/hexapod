...
var assignServos = function() {
  ...
  // Right front leg
  phoenix.r1c = new five.Servo({pin:0, offset: 0, startAt: l.c, range: [50, 180], inverted: true });
  phoenix.r1f = new five.Servo({pin:1, offset: 0, startAt:  l.f, range: [25, 165] });
  phoenix.r1t = new five.Servo({pin:2, offset: 0, startAt: l.t , inverted: true});
  ...
  phoenix.l1f = new five.Servo({pin:1, offset: 0, startAt: l.f, range: [25, 165], inverted: true });
  ...
  //Right mid leg
  phoenix.r2c = new five.Servo({pin:18, offset: 0, startAt: l.c, range: [50, 130], inverted: true });
  phoenix.r2f = new five.Servo({pin:19, offset: 0, startAt: l.f, range: [25, 165] });
  phoenix.r2t = new five.Servo({pin:20, offset: 0, startAt: l.t });
  ...
  phoenix.l2f = new five.Servo({pin:7, offset: 0, startAt: l.f, range: [25, 165], inverted: true });
  ...
  //Right rear leg
  phoenix.r3c = new five.Servo({pin:15, offset: 0, startAt: l.c, range: [50, 180]});
  phoenix.r3f = new five.Servo({pin:16, offset: 0, startAt: l.f, range: [25, 165] });
  phoenix.r3t = new five.Servo({pin:17, offset: 0, startAt: l.t });

  phoenix.r3 = new five.Servo.Array([ phoenix.r3c, phoenix.r3f, phoenix.r3t ]);

  //Left rear leg
  phoenix.l3c = new five.Servo({pin:3, offset: 0, startAt: l.c, range: [50, 180], inverted: true });
  phoenix.l3f = new five.Servo({pin:4, offset: 0, startAt: l.f, range: [25, 165], inverted: true });
...
// =====
  if (false) {
    // Right front leg
    phoenix.r1c = new five.Servo({pin:0, offset: 0, startAt: l.c, range: [50, 180], inverted: false});
    phoenix.r1f = new five.Servo({pin:1, offset: 0, startAt:  l.f, range: [25, 165] });
    phoenix.r1t = new five.Servo({pin:2, offset: 0, startAt: l.t });
    phoenix.r1 = new five.Servo.Array([ phoenix.r1c, phoenix.r1f, phoenix.r1t ]);

    // Left front leg
    phoenix.l1c = new five.Servo({pin:3, offset: 0, startAt: l.c, range: [50, 180], inverted: true});
    phoenix.l1f = new five.Servo({pin:4, offset: 0, startAt:  l.f, range: [25, 165], inverted: true});
    ...
    //Left rear leg
    phoenix.l3c = new five.Servo({pin:9, offset: 0, startAt: l.c, range: [50, 180], inverted: true });
    phoenix.l3f = new five.Servo({pin:10, offset: 0, startAt: l.f, range: [25, 165], inverted: true });
